...
CORS(app, origins= "https://garaziLS.bithub.io/", supports_credentials=True, allow_headers=["Authentication", "Content-Type"])
...
def add_item():
    if request.method == 'OPTIONS':
        ...
        response.headers.add('Access-Control-Allow-Origin', 'https://garaziLS.bithub.io/')
