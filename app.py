...
CORS(app, origins= "https://devcamp-fullstack-project-backend.onrender.com", supports_credentials=True, allow_headers=["Authentication", "Content-Type"])
...
def add_item():
    if request.method == 'OPTIONS':
        ...
        response.headers.add('Access-Control-Allow-Origin', 'https://devcamp-fullstack-project-backend.onrender.com')
